        ...
        <div class="table">
            ...
            >
                    ...
                    >
                        ...
                        <table :style="'width:'+item.width+'px;background:'+item.color"
                            ...
                            <tr>
                                ...
                                <td colspan="4" v-for="(child,i) in column2" :key="i+'-ts'" v-if="i==8" :style="'width:'+child.width+'px;'">{{child.title}}
                                </td>
                                <td colspan="4" v-for="(child,i) in column2" :key="i+'-ds'" v-if="i==9" :style="'width:'+child.width+'px;'">{{child.title}}
                            ...
                            <tr>
                                ...
                                <td v-for="(child2,j) in column4" :key="j+'-qs'" :style="'width:'+child2.width+'px;'">{{child2.title}}
                                    <!--  // 排序-->
                                    <div style="width:40px;display:inline-block;height:36px;position:relative;">
                                        <div style="position:absolute;left:0;bottom:-4px;width:40px;">
                                            <div style="width:40px;font-size:26px;height:18px;line-height:18px;color:#4b98de;"  >
                                                <Icon  type="md-arrow-dropup" v-show="child2.select"  @click.stop="upFilter(child2.name,j,'4')"/>
                                                <Icon  type="md-arrow-dropdown" v-show="!child2.select" @click.stop="downFilter(child2.name,j,'4')"/>
                                            </div>
                                        </div>
                                    </div></td>
                ...
                <tr v-for="(item,index) in mainData" :key="index" style="height:40px;" :id="index">
                    ...
                    >
                        <table :style="'width:'+td.width+'px;background:'+td.color"  style="border-collapse: collapse;height:40px;">
    ...
    export default {
        ...
        watch: {
            ...
            titleData: {
                handler(val, oldVal) {
                    ...
                    if (id != undefined) {
                        localStorage.setItem(id + 'ybZTlist', JSON.stringify(this.titleData));
                    }
                },
        ...
        methods: {
            ...
            double(e) {
                ...
                this.$store.commit("saveZtAuditNo", data.AUDIT_NO);
                ...
                // console.log(this.$store.state.auditNo, 'audio');
