                ...
                <tr style="height:40px;">
                    ...
                    >
                        ...
                        <table :style="'width:'+item.width+'px;background:'+item.color"
                            ...
                            <tr>
                                <td rowspan="2" v-for="(child,i) in column2" :key="i" v-if="i<8"
                                ...
                                <td colspan="4" v-for="(child,i) in column2" :key="i+'-ts'" v-if="i==8"
                                    :style="'width:'+child.width+'px;'">{{child.title}}
                                </td>
                                <td colspan="4" v-for="(child,i) in column2" :key="i+'-ds'" v-if="i==9"
                                    :style="'width:'+child.width+'px;'">{{child.title}}
                            ...
                            <tr>
                                <td v-for="(child2,j) in column3" :key="j" :style="'width:'+child2.width+'px;'">
                                    {{child2.title}}
                                    <!--  // 排序-->
                                    <div style="width:40px;display:inline-block;height:36px;position:relative;">
                                        <div style="position:absolute;left:0;bottom:-4px;width:40px;">
                                ...
                                <td v-for="(child2,j) in column4" :key="j+'-qs'" :style="'width:'+child2.width+'px;'">
                                    {{child2.title}}
                                    <!--  // 排序-->
                                    <div style="width:40px;display:inline-block;height:36px;position:relative;">
                                        <div style="position:absolute;left:0;bottom:-4px;width:40px;">
                                            <div style="width:40px;font-size:26px;height:18px;line-height:18px;color:#4b98de;">
                                                <Icon type="md-arrow-dropup" v-show="child2.select"
                                                      @click.stop="upFilter(child2.name,j,'4')"/>
                                                <Icon type="md-arrow-dropdown" v-show="!child2.select"
                                                      @click.stop="downFilter(child2.name,j,'4')"/>
                                            </div>
                                        </div>
                                    </div>
                                </td>
...
<!--                数据内容行-->
                <tr v-for="(item,index) in mainData" :key="index" style="height:40px;" :id="index" @click="selectRow(index)" :class="{selected:index==isSelected}">
                    <td
                    ...
                    >
                        <table :style="'width:'+td.width+'px;'"
                            ...
                            <tr :id="index">
                                <td v-for="(child,index) in column1" :key="index+'-qs'"
                                    :style="'width:'+child.width+'px;textAlign:'+child.align"
                                    style="border:0;border-right:1px solid #e8eaec">
                ...
                <tr>
                    ...
                    >
                        <table :style="'width:'+td.width+'px;background:'+td.color"
                               style="border-collapse: collapse;height:40px;">
...
<script>
    export default {
        props: ["titleData", "mainData", "pageNum", 'titleChildIndex', 'dataAdd', 'listType'],
        inject: ['reload'],
        computed: {
            tabWidth() {
                let width = 0;
        ...
        mounted() {
            // console.log(this.listType, '列表类型')
            switch (this.listType) {
                case "ctlist":
                    this.findData.auditType='2'
                    this.listSaveId='yblist';
                    this.listSaveNoMethod = 'saveCtAuditNo';
                    this.listRoute='/funding/ctdw';
                    break;
                case "ztlist":
                    this.findData.auditType='1'
                    this.listSaveId='ybZTlist';
                    this.listSaveNoMethod = 'saveZtAuditNo';
                    this.listRoute='/funding/fore';
                    break;
            }
        ...
        watch: {
            ...
            titleData: {
                handler(val, oldVal) {
                    ...
                    if (id != undefined) {
                        localStorage.setItem(id + this.listSaveId, JSON.stringify(this.titleData));
                    }
                },
        ...
        methods: {
            ...
            exlDown(tableid) {
                console.log(this.getExplorer(), '8888888888888')
            ...
            tableToExcel: (function () {
                ...
                return function (table, name) {
                    ...
                    console.log(window, '77997')
                    console.log(9999)
                    console.log(base64(format(template, ctx), 888))
            ...
            upFilter(name, index, type) {
                ...
                switch (type) {
                    ...
                    case '3':
                        ...
                        break
                    case '4':
                        this.column4[index].select = false;
                        break
                }
                console.log('升序')
            ...
            downFilter(name, index, type) {
                ...
                switch (type) {
                    ...
                    case '4':
                        ...
                        this.column4[index].select = true;
                        break
                }
            ...
            double(e) {
                ...
                this.$store.commit(this.listSaveNoMethod, data.AUDIT_NO);
            ...
            mouseup(index) {
                ...
                console.log(444);
                console.log(this.titleData, 'ddddd')
                this.starIndex = -1;
                this.endIndex = -1;
                this.ygcgjFlag = false;
                this.ygcgjEndFlag = false;
