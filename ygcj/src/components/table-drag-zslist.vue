                ...
                <tr style="height:40px;">
                    <!-- 选择 -->
                     <td style="width:50px;height:40px;cursor:default" align="center" bgcolor="#f8f8f9">
                          <input type="checkbox" style="width:18px;height:18px;" @click="checkAll" v-model="checked"></input>
                     </td>
                    <td
                    ...
                    >
                        ...
                        <div style="width:40px;display:inline-block;height:36px;position:relative;">
                            <div style="position:absolute;left:0;bottom:-4px;width:40px;">
                                <div style="width:25px;font-size:26px;height:18px;line-height:18px;color:#4b98de;"  >
...
<script>
    export default {
        ...
        mounted() {
            ...
            console.log(this.titleData,'233')
            switch (this.listType) {
                case "zslist":
                    this.findData.auditType='3'
                    this.listSaveId='zslist';
                    this.listSaveNoMethod = 'saveZsAuditNo';
                    this.listRoute='/funding/application';
                    break;
                case "bllist":
                    this.findData.auditType='4'
                    this.listSaveId='bllist';
                    this.listSaveNoMethod = 'saveZsBlAuditNo';
                    this.listRoute='/funding/applicationBL';
                    break;
                case 'applySupList':
                    this.listSaveId='applySupList';
                    this.listSaveNoMethod = 'saveApplySupNo';
                    this.listRoute='/funding/applySupplement';
                    break;
            }
        ...
        methods: {
            ...
            double(e) {
                ...
                console.log(data)
                if(this.listSaveId == 'applySupList'){
                   this.$store.commit(this.listSaveNoMethod, {auditNo:data.auditNo,applyNo:data.auditSptNo}); 
                }else{
