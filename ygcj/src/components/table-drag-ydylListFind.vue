        ...
        watch: {
            titleData: {
                handler(val, oldVal) {
                    ...
                    if (id != undefined) {
                        localStorage.setItem(id + 'btbzTrainFind', JSON.stringify(this.titleData));
                    }
                },
            ...
            sele(newVal, oldVal) {
                ...
                this.pages = 1;
                let obj = {state: '', row: newVal, page: this.pages,country:''}
                this.getCityAll(obj);
            ...
            pages(newVal, oldVal) {
                ...
                let obj = {state: '', row: this.sele, page: newVal,country:''}
                this.getCityAll(obj);
