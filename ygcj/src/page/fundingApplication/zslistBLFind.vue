        ...
        <div id="funding-a">
            ...
            <Row>
                ...
                <Col span="5"
                    ...
                    <Button style="float:right;height:32px;line-height:20px;"
                            type="primary"
                            v-if="$store.state.info.userAuditType != 0 "
                            @click="spSelect">
...
<script>
    ...
    import tabDragBlPt from '@/components/table-drag-bllistPt.vue'
    ...
    export default {
        ...
        methods: {
            ...
            thSelect() {
                ...
                for (var i = 0; i < getSelect.length; i++) {
                    if (getSelect[i].AUDIT_STATUS != "待业务处室审核") {
            ...
            checkA() {
                ...
                if(localStorage.getItem(id + 'bllistPt') != undefined){
                    localStorage.removeItem(id+'bllistPt')
                }
                this.reload();
        ...
        mounted: function () {
            let id = this.$store.state.info.userId;
            if(JSON.parse(localStorage.getItem(id+'bllistPt')) != undefined){
                this.titleData = JSON.parse(localStorage.getItem(id+'bllistPt'));
