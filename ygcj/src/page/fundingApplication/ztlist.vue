    ...
    export default {
        ...
        methods: {
                    ...
                    if (res.data.ret === 1) {
                        ...
                        this.mainData.forEach(item => {
                            ...
                            item.cellClassName = {
                                ...
                                AUDIT_CS_CITY_FS: 'auditNumStyle',
            ...
            checkA() {
                ...
                if (localStorage.getItem(id + 'ybZTlist') != undefined) {
                    localStorage.removeItem(id + 'ybZTlist')
                }
                this.reload();
        ...
        mounted: function () {
            ...
            let id = this.$store.state.info.userId;
            if (JSON.parse(localStorage.getItem(id + 'ybZTlist')) != undefined) {
                this.titleData = JSON.parse(localStorage.getItem(id + 'ybZTlist'));
        ...
        data() {
            return {
                titleChildIndex: 14,//titleData的复杂表格项
                auditMulStatus:[],
                //单据状态列表
                auditStatusList:[
                    {
