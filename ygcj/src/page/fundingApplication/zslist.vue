    ...
    export default {
        ...
        methods: {
            ...
            checkA() {
                ...
                if(localStorage.getItem(id + 'zslist') != undefined){
                    localStorage.removeItem(id+'zslist')
                }
                this.reload();
        ...
        mounted: function () {
            ...
            let id = this.$store.state.info.userId;
            if (JSON.parse(localStorage.getItem(id + 'zslist')) != undefined) {
                this.titleData = JSON.parse(localStorage.getItem(id + 'zslist'));
