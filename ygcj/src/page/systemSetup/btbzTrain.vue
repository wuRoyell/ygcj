...
<script>
    import dragBtTrain from '@/components/table-drag-btbzTrain.vue';
    ...
    export default {
        ...
        methods: {
            ...
            checkA() {
                ...
                if(localStorage.getItem(id + 'btbzTrain') != undefined){
                    localStorage.removeItem(id+'btbzTrain')
                }
                this.reload()
            },
        ...
        mounted: function () {
            let id = this.$store.state.info.userId;
            if (JSON.parse(localStorage.getItem(id + 'btbzTrain')) != undefined) {
                this.titleData = JSON.parse(localStorage.getItem(id + 'btbzTrain'));
            }
