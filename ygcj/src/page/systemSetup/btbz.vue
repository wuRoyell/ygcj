    ...
    export default {
        ...
        methods: {
            ...
            checkA() {
                ...
                if(localStorage.getItem(id + 'btbz') != undefined){
                    localStorage.removeItem(id+'btbz')
                }
                this.reload();
        ...
        mounted: function () {
            ...
            if(JSON.parse(localStorage.getItem(id+'btbz')) != undefined){
                this.titleData = JSON.parse(localStorage.getItem(id+'btbz'));
            }
